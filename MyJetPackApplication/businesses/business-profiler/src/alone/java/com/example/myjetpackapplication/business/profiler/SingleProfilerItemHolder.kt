 ...
 */
class SingleProfilerItemHolder(context: Context, binding: ItemSingleProfilerBinding) :
    BasicViewHolder<BusinessItem, ItemSingleProfilerBinding>(context, binding) {
