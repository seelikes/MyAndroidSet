...
class SingleVideoActivity :
    ...
    override fun initModel(savedInstanceState: Bundle?): SingleVideoViewModel =
        SingleVideoViewModel(
            this,
            DataBindingUtil.setContentView(this, R.layout.activity_single_video)
        )

    override fun initView(binding: ActivitySingleVideoBinding) {
    ...
    override fun onBackPressed() {
        ...
        if (pageUp?.isNotEmpty() == true) {
            ViewModelProviders.of(this).get(SingleVideoDataModel::class.java).items.value = pageUp
            return
        }
        super.onBackPressed()
    }
