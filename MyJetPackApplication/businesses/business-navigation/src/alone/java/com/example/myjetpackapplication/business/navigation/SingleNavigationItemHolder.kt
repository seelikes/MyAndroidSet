 ...
 */
class SingleNavigationItemHolder(context: Context, binding: ItemSingleNavigationBinding) :
    BasicViewHolder<BusinessItem, ItemSingleNavigationBinding>(context, binding) {
