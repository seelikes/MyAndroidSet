 ...
 */
class SinglePagingItemHolder(weakContext: WeakReference<Context>, binding: ItemSinglePagingBinding) :
    BasicViewHolder<BusinessItem, ItemSinglePagingBinding>(weakContext, binding) {
