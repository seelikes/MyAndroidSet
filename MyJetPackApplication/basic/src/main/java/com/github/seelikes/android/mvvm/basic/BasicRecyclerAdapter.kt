 ...
 */
abstract class BasicRecyclerAdapter<T : Any, VH: BasicViewHolder<T, *>> @JvmOverloads constructor(@Suppress("unused") protected val context: Context, @Suppress("MemberVisibilityCanBePrivate") protected var items: List<T>? = null, private val itemClickListener: ((T?, Int) -> Unit)? = null, protected val routineScope: CoroutineScope? = null) : RecyclerView.Adapter<VH>() {
