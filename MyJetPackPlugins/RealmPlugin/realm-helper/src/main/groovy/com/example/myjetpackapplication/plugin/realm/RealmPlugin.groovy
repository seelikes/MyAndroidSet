...
class RealmPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        project.dependencies.add("implementation", "com.github.seelikes.android:realm-annotation:1.0.04")
        project.dependencies.add("implementation", "com.github.seelikes.android:realm-api:1.0.04")
